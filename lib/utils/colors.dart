...
class AppColors{
  ...
  static final Color mainColor = const Color(0xff9c45e3);
  ...
  static final Color contnerColor = const Color(0xffe2d2fa);
  static final Color buttomNavColor = const Color(0xfff0e8fd);
}